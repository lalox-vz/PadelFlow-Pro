---
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user specifically asks to create, build, or generate a new 'skill' or 'antigravity skill'.
---
