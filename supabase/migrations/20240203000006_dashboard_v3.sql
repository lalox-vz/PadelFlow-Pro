-- DASHBOARD RPC V3: Complete KPI Suite
-- Features: Occupancy Rate, Booking Count, All Growth Rates, Ticket Promedio Fix
...
BEGIN
    ...
    -- 2. Active Clients (Unique users who booked)
